...
impl WheelCache {
    ...
    pub async fn get_wheel(
        ...
        // For this PR, we rely on Downloader which is smart enough to skip redundant
        // downloads if the file exists and the checksum matches.
        self.downloader
